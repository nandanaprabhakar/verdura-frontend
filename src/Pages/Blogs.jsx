                ...
                <ImageListItem
                  ...
                  >
                    ...
                    <Box sx={{ position: "absolute", display: 'flex', justifyContent: 'center', textAlign: 'center', color: "#DAF1DE", whiteSpace: 'pre-line', background: hover == index ? 'none' : 'rgba(225,225,225,0.08)', backdropFilter: 'blur(5px)', WebkitBackdropFilter: 'blur(15px)', }}>
                      {hover == index ? (
                        <>
                          <Typography component="p" className="mx-3" sx={{ textAlign: 'start', display: { xs: 'block', md: 'none' }, fontSize: { xs: '13px', sm: '15px' } }}>{item.hoverText?.slice(0, 50)}...</Typography>
                          <Typography component="p" className="mx-3" sx={{ textAlign: 'start', display: { xs: 'none', md: 'block' }, fontSize: { xs: '13px', sm: '15px', md: '16px' } }} >{item.hoverText} </Typography>
                          </> 
